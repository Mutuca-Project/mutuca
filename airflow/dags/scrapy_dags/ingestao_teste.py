...
# Importa função ETL do script local
...
with DAG(
    ...
    dbt_run = DockerOperator(
        ...
        auto_remove=True,
        network_mode="mutuca-lakehouse_lakehouse-net",
        mount_tmp_dir=False, # evitar o erro de mount do /tmp no DooD
        # Executa apontando para os diretórios montados
        command="run --profiles-dir . --project-dir . --target prod",
        docker_url="unix://var/run/docker.sock"
    )

    setup_env >> run_scraper >> load_bronze >> dbt_run
