...
class OCIUploadPDFPipeline(FilesPipeline):
    ...
    def download_file(self, file_url):
        try:
            ...
            if response.status_code == 200:
                ...
                logging.info(f"Failed to download file from {file_url} - Status Code: {response.status_code}")        
    ...
    def upload_to_oci_bucket(self, item, file_content):
        ...
        try:
            ...
            logging.info(f"File '{file_name}' has been uploaded to bucket '{self.bucket_name}'.")
    ...
    def __inicialize_oci_client(self):
        try:
            config = {
